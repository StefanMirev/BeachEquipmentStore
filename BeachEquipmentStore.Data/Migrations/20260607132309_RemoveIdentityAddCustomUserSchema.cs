...
{
    /// <inheritdoc />
    public partial class RemoveIdentityAddCustomUserSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameIndex(
                ...
                table: "CartItems",
                newName: "IX_CartItems_CustomerUserId");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AdminUsers_UserRoles_UserRoleId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GdprConsentGivenAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    MarketingPreferences = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UserRoleId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CustomerUsers_UserRoles_UserRoleId",
                        column: x => x.UserRoleId,
                        principalTable: "UserRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdminUsers_UserRoleId",
                table: "AdminUsers",
                column: "UserRoleId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerUsers_UserRoleId",
                table: "CustomerUsers",
                column: "UserRoleId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Addresses_CustomerUsers_CustomerUserId",
                table: "Addresses",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_CartItems_CustomerUsers_CustomerUserId",
                table: "CartItems",
                column: "CustomerUserId",
                principalTable: "CustomerUsers",
                principalColumn: "Id",
