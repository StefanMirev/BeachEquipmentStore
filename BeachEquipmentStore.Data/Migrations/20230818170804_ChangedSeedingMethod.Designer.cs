...
namespace BeachEquipmentStore.Data.Migrations
{
    ...
    [Migration("20230818170804_ChangedSeedingMethod")]
    partial class ChangedSeedingMethod
    {
            ...
            modelBuilder.Entity("BeachEquipmentStore.Data.Models.Address", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f22af289-c26e-4c1b-9a06-e6be615b1395"),
                            CustomerId = new Guid("4c1252e1-7bab-4311-a5f5-2135dc4aa5ee"),
                            Name = "ул. Кракра №3",
                            Town = "София",
                            ZipCode = 1000
                        },
                        new
                        {
                            Id = new Guid("5c3a6b6e-fd7c-4b3a-8e64-2288fb962cfe"),
                            CustomerId = new Guid("74a35674-cf12-4a36-ad92-e8ca67f70913"),
                        ...
                        new
                        {
                            Id = new Guid("b949cd46-00d8-4f9f-9fde-00f447d9245d"),
                            CustomerId = new Guid("74a35674-cf12-4a36-ad92-e8ca67f70913"),
            ...
            modelBuilder.Entity("BeachEquipmentStore.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4c1252e1-7bab-4311-a5f5-2135dc4aa5ee"),
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "432cb313-c750-43ea-9b6a-410cfce61a9a",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEFm7OAKeLa5zh1fCJEXrTdUx/fh/N7dsyDxH/nFQP8JeGHmoKAtpgU3j1fRBcmJXAg==",
                            PhoneNumber = "0876596224",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "1770174a-d01f-409e-a69f-c34089dc2bc8",
                            TwoFactorEnabled = false,
                            UserName = "p.petrov@mail.com"
                        },
                        new
                        {
                            Id = new Guid("74a35674-cf12-4a36-ad92-e8ca67f70913"),
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "bc62c3e4-3e88-4d8d-938b-c3251f4b48e5",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEDzvwhQwskEwoj/qOxGY50Y9Ec/rTEjIrUzfgxZc4W1JNN1qVAMBeMc9GA4UjkqWew==",
                            PhoneNumber = "0888202449",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "65582c3f-4bb7-433d-be85-9b902971bf85",
                            TwoFactorEnabled = false,
                            UserName = "n.flacko@mail.com"
                        },
                        new
                        {
                            Id = new Guid("9c098d1f-42bd-4a7d-8857-0fcbaacb6ea7"),
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "112df40e-c31e-435f-ac67-ef04d7ee873d",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEKcFOJlc4esUsIxES39zgaXqg2XsDcvIH2he+rkQiCf/upP/Ppm6HvVCIKije7w6BQ==",
                            PhoneNumber = "0885527733",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "59c59a36-0df3-4560-b5d0-1686b5d4cf85",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("BeachEquipmentStore.Data.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("016413be-bf9b-4af1-9f05-f0c06920d030"),
                            Barcode = 57532,
                            CategoryId = 1,
                        ...
                        new
                        {
                            Id = new Guid("6e4f94c2-27a2-4af5-968f-18ce6fb3b4d9"),
                            Barcode = 38527,
                            CategoryId = 1,
                        ...
                        new
                        {
                            Id = new Guid("9296dc9a-f75d-42c4-b4ec-eb695ae02f82"),
                            Barcode = 57523,
                            CategoryId = 1,
                        ...
                        new
                        {
                            Id = new Guid("206c8e6a-7f9e-4df2-b698-cbf6c03ef6fd"),
                            Barcode = 57526,
                            CategoryId = 1,
                        ...
                        new
                        {
                            Id = new Guid("2552921c-a15e-49dc-a099-b9e01ea11437"),
                            Barcode = 56130,
                            CategoryId = 1,
                        ...
                        new
                        {
                            Id = new Guid("a392f5df-123b-4b70-a1e3-aee2d94f8ead"),
                            Barcode = 58922,
                            CategoryId = 1,
                        ...
                        new
                        {
                            Id = new Guid("89c45ec7-44c6-4ae7-87ec-1d44351ba370"),
                            Barcode = 55555,
                            CategoryId = 2,
                        ...
                        new
                        {
                            Id = new Guid("6726df92-df56-4d99-9d79-409cb8487750"),
                            Barcode = 44443,
                            CategoryId = 2,
                        ...
                        new
                        {
                            Id = new Guid("83d3620e-b65b-4f9f-b2c7-9454dd3d34fc"),
                            Barcode = 44442,
                            CategoryId = 2,
                            Description = "Чадърите на \"Публиидея\" са перфектният аксесоар за горещите дни на плажа и ще Ви предпази парещите слънчеви лъчи. Лeceн е зa мoнтиpaнe, ocигypявa зaщитa oт cлънчeвитe лъчи UV20+. Moжe лecнo дa бъдe нагласен в кoятo и дa e пocoкa, блaгoдapeниe нa чупещошд рамо. Диаметър: 100 см.",
                        ...
                        new
                        {
                            Id = new Guid("aa6c7d00-4915-483d-9bde-49b7abf69b6d"),
                            Barcode = 44444,
                            CategoryId = 2,
                            Description = "Чадърите на \"Публиидея\" са перфектният аксесоар за горещите дни на плажа и ще Ви предпази парещите слънчеви лъчи. Лeceн е зa мoнтиpaнe, ocигypявa зaщитa oт cлънчeвитe лъчи UV20+. Moжe лecнo дa бъдe нагласен в кoятo и дa e пocoкa, блaгoдapeниe нa чупещошд рамо. Диаметър: 100 см.",
                        ...
                        new
                        {
                            Id = new Guid("00bdbbd0-97f7-46fa-a4b5-ddb579836931"),
                            Barcode = 56718,
                            CategoryId = 3,
                        ...
                        new
                        {
                            Id = new Guid("2e5bccbc-3193-49c8-9980-cb0e9563eaa3"),
                            Barcode = 56724,
                            CategoryId = 3,
                        ...
                        new
                        {
                            Id = new Guid("ddb5c148-724a-4bb8-a5fb-f5090e5d9985"),
                            Barcode = 56723,
                            CategoryId = 3,
                        ...
                        new
                        {
                            Id = new Guid("e8e97374-83c2-4345-8963-778b3cb9b2db"),
                            Barcode = 56721,
                            CategoryId = 3,
                        ...
                        new
                        {
                            Id = new Guid("9f28b31a-7cac-4ef3-a046-b4fefd68114c"),
                            Barcode = 56720,
                            CategoryId = 3,
                        ...
                        new
                        {
                            Id = new Guid("f35010a0-af3e-438b-a4a8-ff362c7224db"),
                            Barcode = 18040,
                            CategoryId = 4,
                        ...
                        new
                        {
                            Id = new Guid("d9eabeeb-b034-432f-a692-dc24fb998769"),
                            Barcode = 17005,
                            CategoryId = 4,
                        ...
                        new
                        {
                            Id = new Guid("84b836b5-eba1-4ede-b7ca-8c59a304ddf5"),
                            Barcode = 10805,
                            CategoryId = 4,
                        ...
                        new
                        {
                            Id = new Guid("f9163036-65df-4c08-94b0-1c9370058126"),
                            Barcode = 33306,
                            CategoryId = 4,
                        ...
                        new
                        {
                            Id = new Guid("3bf9a654-4cfe-4eb9-b577-7783551d627e"),
                            Barcode = 36113,
                            CategoryId = 4,
                        ...
                        new
                        {
                            Id = new Guid("4e6bc1d1-ca62-4d3c-ad8b-0a02b227980b"),
                            Barcode = 58849,
                            CategoryId = 4,
                        ...
                        new
                        {
                            Id = new Guid("3d7f1a2c-63e4-4043-bc5c-7d94c3e0acbb"),
                            Barcode = 42178,
                            CategoryId = 5,
                        ...
                        new
                        {
                            Id = new Guid("52c1f521-19c3-4302-b46f-dd59ce7dd69c"),
                            Barcode = 59139,
                            CategoryId = 5,
                        ...
                        new
                        {
                            Id = new Guid("88447b07-2748-4dc3-8915-ee2959fd8b75"),
                            Barcode = 42181,
                            CategoryId = 5,
                            Description = "Плавниците cа подходящи за гмуркане или тренировки по плуване. Tяхната площ ще даде възможноcт на вcеки любител на водните приключения да cе движи много по-бързо!",
                        ...
                        new
                        {
                            Id = new Guid("98c57088-cd9b-4c81-8364-4d818c4757cf"),
                            Barcode = 24040,
                            CategoryId = 5,
                        ...
                        new
                        {
                            Id = new Guid("3643bd52-9c82-4cd7-a751-a1b0223dba60"),
                            Barcode = 31386,
                            CategoryId = 5,
                        ...
                        new
                        {
                            Id = new Guid("64ce359f-3853-4d18-bd4b-760979a4ad37"),
                            Barcode = 51375,
                            CategoryId = 5,
                        ...
                        new
                        {
                            Id = new Guid("fc34a66c-2a55-4791-b180-f6ba3138bc08"),
                            Barcode = 42174,
                            CategoryId = 5,
                        ...
                        new
                        {
                            Id = new Guid("2e8ab347-31f1-4adc-9165-ba1d35ed2f17"),
                            Barcode = 42172,
                            CategoryId = 5,
                        ...
                        new
                        {
                            Id = new Guid("6e6a0449-d37f-41e9-a7eb-1d3729c7d6c4"),
                            Barcode = 58546,
                            CategoryId = 6,
                        ...
                        new
                        {
                            Id = new Guid("0d921ba7-0f9b-4d31-b8da-c150252de37a"),
                            Barcode = 49230,
                            CategoryId = 6,
                        ...
                        new
                        {
                            Id = new Guid("993aa62a-af5f-4d96-8a82-645c933cc0ae"),
                            Barcode = 36727,
                            CategoryId = 6,
                        ...
                        new
                        {
                            Id = new Guid("d7dbbc8b-550f-4c2f-acb8-c26bbd85595c"),
                            Barcode = 56113,
                            CategoryId = 6,
                        ...
                        new
                        {
                            Id = new Guid("16bb03b4-3a9b-42eb-9c8c-387f253028f6"),
                            Barcode = 58762,
                            CategoryId = 6,
                        ...
                        new
                        {
                            Id = new Guid("d5fa1649-5938-4512-8021-8fe573e4e2ef"),
                            Barcode = 59720,
                            CategoryId = 6,
                        ...
                        new
                        {
                            Id = new Guid("e6e88e95-3bef-4273-adc9-842ceeacfc64"),
                            Barcode = 58786,
                            CategoryId = 6,
                        ...
                        new
                        {
                            Id = new Guid("1ce94471-b47c-490e-965d-58f0762dc830"),
                            Barcode = 101730,
                            CategoryId = 7,
                        ...
                        new
                        {
                            Id = new Guid("856e0816-882a-4a86-ae7f-66f8f203cc1e"),
                            Barcode = 101019,
                            CategoryId = 7,
                            Description = "Висококачествена топка с диаметър 21см. Игрите с топка ще помогнат на децата да задоволят естественото си желание за движение по забавен начин. Те използват енергията си по подходящ начин - активното движение на чист въздух е полезно за здравето и в същото време носи радост от играта.",
                        ...
                        new
                        {
                            Id = new Guid("d2937764-9e12-4330-b0fb-172296b2b10d"),
                            Barcode = 101090,
                            CategoryId = 7,
                            Description = "Висококачествена топка с диаметър 21см. Игрите с топка ще помогнат на децата да задоволят естественото си желание за движение по забавен начин. Те използват енергията си по подходящ начин - активното движение на чист въздух е полезно за здравето и в същото време носи радост от играта.",
                        ...
                        new
                        {
                            Id = new Guid("647e4e39-98ad-46a8-a30d-5c3c5274768a"),
                            Barcode = 101011,
                            CategoryId = 7,
                            Description = "Висококачествена топка с диаметър 21см. Игрите с топка ще помогнат на децата да задоволят естественото си желание за движение по забавен начин. Те използват енергията си по подходящ начин - активното движение на чист въздух е полезно за здравето и в същото време носи радост от играта.",
